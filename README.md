...
1. Clone the repo:
   ...
   ```
2. Create a Thingsboard account at https://demo.thingsboard.io/ and login to use Thingsboard Live Demo server. Jump to [Thingsboard](https://github.com/hungdaqq/Smarthome-IoT/tree/main/Thingsboard) to get a quick overview about this open-source IoT platform.
